...
orderRouter.post("/order", requireAuth, (req: any, res) => {
...
orderRouter.get("/order/:orderId", requireAuth, (req: any, res) => {
...
orderRouter.delete("/order/:orderId", requireAuth, (req: any, res) => {
    const userId = req.userId;
    const orderId = req.params.orderId;
...
orderRouter.get("/orders", requireAuth, (req: any, res) => {
    const userId = req.userId;
    const userOrders = ORDERS.filter((order) => order.userId === userId);
    return res.json(userOrders);
});

orderRouter.get("/fills", requireAuth, (req: any, res) => {
    const userId = req.userId;
